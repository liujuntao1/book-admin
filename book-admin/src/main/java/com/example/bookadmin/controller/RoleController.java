...
public class RoleController {
    ...
    // 获取全部角色
    @GetMapping
    public CommonResult<Page<Role>> listRoles(@RequestParam(defaultValue = "1") Integer page,
                                              @RequestParam(defaultValue = "10") Integer size) {
        return CommonResult.success(roleService.page(Page.of(page, size)));
    }
    ...
    // 修改角色
    @PutMapping
    public CommonResult<String> updateRole(@RequestBody Role role) {
